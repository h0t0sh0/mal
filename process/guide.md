...
Цель проекта Make-A-Lisp - облегчить написание собственного интерпретатора Lisp, не жертвуя многими моментами "Ага!", которые произошли от взбирания на гору Маккарти. Когда вы достигните пика этой горы, у вас будет интерпретатор для языка mal Lisp, который достаточно мощный, чтобы быть самостоятельным, что означает - он будет способен запустить mal интерпретатор, написанный на самом себе.
...
- [Make-A-Lisp процесс](#make-a-lisp-процесс-1)
